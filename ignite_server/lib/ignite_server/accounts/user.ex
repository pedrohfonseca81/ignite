defmodule Ignite.Server.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_username(changeset, opts) do
    if Keyword.get(opts, :validate_username, true) do
      changeset
      |> unsafe_validate_unique(:username, Ignite.Server.Repo)
  ...
  """
  def valid_password?(%Ignite.Server.Accounts.User{hashed_password: hashed_password}, password)
