defmodule Ignite.ServerWeb.CoreComponents do
  @moduledoc """
  ...
  import Ignite.ServerWeb.Gettext
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-2 right-2 mr-2 w-80 sm:w-96 z-50 rounded-lg p-3 m-2",
        @kind == :info && "bg-emerald-50 text-emerald-800 fill-cyan-900",
        @kind == :error && "bg-rose-50 text-rose-900 shadow-md fill-rose-900"
      ]}
      {@rest}
    >
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-red-700 hover:bg-red-800 py-2 px-3",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Ignite.ServerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Ignite.ServerWeb.Gettext, "errors", msg, opts)
    end
  end
